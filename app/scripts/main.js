(function() {
	...
	document.getElementById ("fill").addEventListener ("change", setMap, false);
	document.getElementById ("stroke").addEventListener ("change", setMap, false);
	document.getElementById ("blending").addEventListener ("change", setMap, false);
	document.getElementById ("labels").addEventListener ("change", setMap, false);
debugger;
	var location=[40.416879, -3.703351];
	var geojson='/assets/cartodb-query.geojson'
	var world="pepito"
	var width = 640,
	    height = 420,
	    centered;
...
debugger
	    ...
	    projection = d3.geo.mercator(location)
	    	.scale(500)
	    	.center( location )//[9.30001242974,13.3900247789])
...
//debugger;
	    ...
	    var center = d3.geo.centroid(location); 
